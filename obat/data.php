    ...
    <div class="box">
			...
			<table class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th>Nama Obat</th>
						<th>Keterangan</th>
						<th class="text-center"><i class="glyphicon glyphicon-cog"></th>
					</tr>
				</thead>
				<tbody>
				<?php
				...
				$sql_poli = mysqli_query($conn, $query) or die (mysqli_error($conn));
		...
		<?php if(@$_POST['pencarian'] == '') { ?>
			<div style="float:left;">
				<?php $jml = mysqli_num_rows(mysqli_query($conn, $queryJml));
